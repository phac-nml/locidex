...
- Include quality metrics to locidex report. [PR 42](https://github.com/phac-nml/locidex/pull/42).
- Add argument to `locidex merge` to select loci in the final `profile.tsv` output file. [PR 46](https://github.com/phac-nml/locidex/pull/46)
...
[v0.4.0]: https://github.com/phac-nml/locidex/releases/tag/v0.4.0
